      ...
      {view === "list" && (
        ...
        <>
            ...
            <div className="ParteSala">
                ...
                <Button className="aAcao" onClick={() => setView("create")}>Cadastrar Novo Avaliações</Button>
                ...
                <table className="Tabela">
                    ...
                    <tbody>
                    <tr>
                        <td className="LinhaDado">prova 1</td>
                        <td className="LinhaDado">20%</td>
                        <td className="LinhaDado">01/04/2205</td>
